...
import com.demo.adsmanage.Activity.PayAllSubsciptionExterimentActivity.Companion.plans
...
class SubscriptionExperimentPayAllExperimentViewModel(
    var binding: ActivityPayAllSubsciptionExterimentBinding,
...
//                                    }" + mActivity.resources.getString(R.string.month_static)
                                ...
                                yearstaticprice.text =
                                    "${price.first()}${
                                        convertYearlyToWeekly(pricemic.toDouble()).roundToInt()
                                    }" + mActivity.resources.getString(R.string.week_static)
                            ...
                            try {
                                ...
                                weekstaticpriceset.text = price.replace(
                                    ".00",
                                    ""
                    ...
                    if (testpackagerenlist.isNotEmpty()) {
                        ...
                        try {
                            ...
                            YearSavePre.text = mActivity.getString(
                                R.string.save, calculateDiscount(
                                    weekprice.toDouble(),
                                    yearprice.toDouble()
                                ).roundToInt()
                            )
