...
import com.demo.adsmanage.Activity.TimerOfferActivity.Companion.plans
...
class SubscriptionOnePlanTimerViewModel(
    var binding: ActivityTimerOfferBinding,
...
//                                }" + mActivity.resources.getString(R.string.week_static)
//                            } catch (e: Exception) {
//                            }
...
//                                yearstaticprice.text =
//                                    "${price.first()}${
//                                        pricemic.toDouble().div(12).roundToInt()
//                                    }" + mActivity.resources.getString(R.string.month_static)

                                yearstaticprice.text =
                                    "${price.first()}${
                                        convertYearlyToDaily(pricemic.toDouble()).roundToInt()
                                    }" + mActivity.resources.getString(R.string.day_static)

                                try {
                                    yearstaticpriceoffer.text = mActivity.getString(
                                        R.string.year_price, "${price.first()}${
                                            85.toDouble().times(52).roundToInt()
                                        }"
                                    )
                                } catch (e: Exception) {
                                }
...
//                            txtlifePrice.text = price.replace(".00", "")
                    ...
                    if (testpackagerenlist.isNotEmpty()) {
                        ...
                        try {
                            ...
                            val yearprice = year?.product?.price?.amountMicros?.div(1000000) ?: 120
                            val monthprice =
                                month?.product?.price?.amountMicros?.div(1000000) ?: 120
                            val weekprice = week?.product?.price?.amountMicros?.div(1000000) ?: 120
...
//                            YearSavePre.text = mActivity.getString(
//                                R.string.off_today, calculateDiscount(
//                                    85.toDouble(),
//                                    yearprice.toDouble()
//                                ).roundToInt()
//                            )

//                            MonthSavePre.text = mActivity.getString(
//                                R.string.save, calculateMonthlyDiscountFixedWeeks(
//                                    weekprice.toDouble(),
//                                    monthprice.toDouble()
//                                ).second.roundToInt()
//                            )
...
//                        YearSavePre.text = mActivity.getString(R.string.save,yearly?.second)
//                        MonthSavePre.text = mActivity.getString(R.string.save, monthly?.second)
                    }
...
//            yearconstraintid.setBackgroundResource(R.drawable.bgyearnewexperimentnew_experiment)
//            weekconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
//            lifeconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
//            monthconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
//            monthSelection.setImageResource(R.drawable.unselected_round)
//            lifetimeSelection.setImageResource(R.drawable.unselected_round)
//            yearSelection.setImageResource(R.drawable.selected_round)
//            weekSelection.setImageResource(R.drawable.unselected_round)
...
//                }
//                isbilingopen = true
//                txtBottom.beInvisible()
//
////                mIVMonthSelection.setImageResource(R.drawable.uncheckicon)
////                mIVYearSelection.setImageResource(R.drawable.uncheckicon)
////                mIVlifeSelection.setImageResource(R.drawable.mycheckiconsvg)
////                yearconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
////                monthconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
////                lifeconstraintid.setBackgroundResource(R.drawable.bgyearnewexperimentnew_experiment)
////                weekconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
////                monthSelection.setImageResource(R.drawable.unselected_round)
////                lifetimeSelection.setImageResource(R.drawable.selected_round)
////                yearSelection.setImageResource(R.drawable.unselected_round)
////                weekSelection.setImageResource(R.drawable.unselected_round)
//
//                if (mIsRevenuCat!!) {
//                    if (packagerenlist.isNotEmpty()) {
...
////                weekconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
//                lifeconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
//                monthconstraintid.setBackgroundResource(R.drawable.bgyearnewexperimentnew_experiment)
//                weekconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
//
//                monthSelection.setImageResource(R.drawable.selected_round)
//                lifetimeSelection.setImageResource(R.drawable.unselected_round)
//                yearSelection.setImageResource(R.drawable.unselected_round)
//                weekSelection.setImageResource(R.drawable.unselected_round)
//
...
//                monthconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
//                lifeconstraintid.setBackgroundResource(R.drawable.bgyearopacitynewexperimentnew_experimant)
//                weekconstraintid.setBackgroundResource(R.drawable.bgyearnewexperimentnew_experiment)
//
//
//                monthSelection.setImageResource(R.drawable.unselected_round)
//                lifetimeSelection.setImageResource(R.drawable.unselected_round)
//                yearSelection.setImageResource(R.drawable.unselected_round)
//                weekSelection.setImageResource(R.drawable.selected_round)
//
//
//                mIVMonthSelection.setImageResource(R.drawable.uncheckicon)
////                mIVweekSelection.setImageResource(R.drawable.uncheckicon)
...
//    return Pair()
    ...
    fun convertYearlyToDaily(yearlyPrice: Double): Double {
        val daysInYear = 365.0
        return yearlyPrice / daysInYear
    }
