...
class BillingClientLifecycle private constructor(
     ...
     */
    val skusWithSkuDetails = MutableLiveData<Map<String, ProductDetails>>()
    ...
    fun create() {
        ...
        billingClient = BillingClient.newBuilder(app.applicationContext)
            .setListener(this)
            .enablePendingPurchases(PendingPurchasesParams.newBuilder().enableOneTimeProducts().enablePrepaidPlans().build()) // Not used for subscriptions.
            .build()
...
//            }
     ...
     *
     * Store the ProductDetails and post them in the [skusWithSkuDetails]. This allows other parts
     * of the app to use the [ProductDetails] to show SKU information and make purchases.
     */
        ...
        when (responseCode) {
            BillingClient.BillingResponseCode.OK -> {
                ...
                if (productDetailsList.isEmpty()) {
                    ...
                    skusWithSkuDetails.postValue(HashMap<String, ProductDetails>().apply {
