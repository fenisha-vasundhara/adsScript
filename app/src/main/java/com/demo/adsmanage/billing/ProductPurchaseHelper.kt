                    ...
                    when (billingResult.responseCode) {
                        BillingClient.BillingResponseCode.OK -> {
                            if (purchases != null) {
                                ...
                                Log.d(
                                    TAG,
                                    "onPurchasesUpdated: =>> Response OK But Purchase List Null Found"
                                )
                            }
                        }
                            ...
                            when (billingResult.responseCode) {
                                ...
                                BillingClient.BillingResponseCode.USER_CANCELED -> {
                                    if (billingResult.responseCode == BillingClient.BillingResponseCode.USER_CANCELED) {
                                        ...
                                        Toast.makeText(
                                            context,
                                            context.resources.getString(R.string.Youve_cancelled),
                                            Toast.LENGTH_SHORT
                                        ).show()
                                    }
                                }
                                    ...
                                    Toast.makeText(
                                        context,
                                        context.resources.getString(R.string.Item_not_found),
                                        Toast.LENGTH_SHORT
                                    ).show()
                                }
                            }
