...
class SliderViewPagerExAdapter(val context: Context, val imageList: List<Int>, private val viewPager: ViewPager) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val itemView: View = mLayoutInflater.inflate(R.layout.image_slider_item_auto_ex, container, false)
...
//            textset.visibility = View.VISIBLE
            if (position == 0) {
                textset.setText(R.string.Schedule_Message_ex)
            } else if (position == 1) {
                textset.setText(R.string.Translate_Message_ex)
            } else if (position == 2) {
                textset.setText(R.string.Block_Unwanted_Messages_ex)
            } else if (position == 3) {
                textset.setText(R.string.No_Ads_ex)
            } else if (position == 4) {
                textset.setText(R.string.Customize_Theme_ex)
            }
