...
public class MessageChatLayout extends FrameLayout {
    ...
    public MessageChatLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MessageChatLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(21)
    public MessageChatLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
