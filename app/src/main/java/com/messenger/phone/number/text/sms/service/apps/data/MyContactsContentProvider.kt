...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.messenger.phone.number.text.sms.service.apps.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.messenger.phone.number.text.sms.service.apps") {
                return contacts
            }
