...
import com.messenger.phone.number.text.sms.service.apps.CommanClass.updateMenuItemColors
...
abstract class MyRecyclerViewAdapter(val activity: Activity, val recyclerView: MyRecyclerView, val itemClick: (Any) -> Unit) :
