...
import com.messenger.phone.number.text.sms.service.apps.camera.FLASH_ALWAYS_ON
import com.messenger.phone.number.text.sms.service.apps.camera.FLASH_ON
import com.messenger.phone.number.text.sms.service.apps.camera.PERMISSION_ACCESS_FINE_LOCATION
import com.messenger.phone.number.text.sms.service.apps.camera.checkLocationPermission
import com.messenger.phone.number.text.sms.service.apps.camera.handlePermission
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.BitmapUtils
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.CameraErrorHandler
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.ImageQualityManager
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.ImageSaver
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.MediaOutput
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.MediaOutputHelper
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.MediaSizeStore
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.MediaSoundHelper
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.PinchToZoomOnScaleGestureListener
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.SimpleLocationManager
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.VideoQualityManager
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.toAppFlashMode
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.toCameraSelector
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.toCameraXFlashMode
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.toCameraXQuality
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.toLensFacing
import com.messenger.phone.number.text.sms.service.apps.camera.models.MySize
import com.messenger.phone.number.text.sms.service.apps.camera.models.*
...
class CameraXPreview(
    ...
    private fun startCamera(switching: Boolean = false) {
        ...
        cameraProviderFuture.addListener({
            try {
                ...
                val errorMessage =
                    if (switching) com.messenger.phone.number.text.sms.service.apps.R.string.camera_switch_error else com.messenger.phone.number.text.sms.service.apps.R.string.camera_open_error
    ...
    override fun tryTakePicture() {
        if (imageCapture == null) {
            activity.toast(com.messenger.phone.number.text.sms.service.apps.R.string.camera_open_error)
            return
        }
