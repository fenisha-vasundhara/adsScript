...
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.ImageUtil.imageToJpegByteArray
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.ImageUtil.jpegImageToJpegByteArray
...
class ImageSaver private constructor(
    ...
    private fun saveImageToTempFile(): File? {
        ...
        try {
            ...
            errorMessage = "Failed to write temp file"
            exception = e
        } catch (e: ImageUtil.CodecFailedException) {
            when (e.failureType) {
                ...
                ImageUtil.CodecFailedException.FailureType.UNKNOWN -> {
