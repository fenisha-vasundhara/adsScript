...
import com.messenger.phone.number.text.sms.service.apps.databinding.FragmentPersonalBinding
...
@AndroidEntryPoint
class PersonalFragment : Fragment(), MessageClick, MoreOPtionClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            adapterMainMassage.setInterface(this@PersonalFragment)
            adapterMainMassage.setInterfaceMoreClick(this@PersonalFragment)

            val model = ViewModelProvider(requireActivity())[GetAllPersnalConversationViewModel::class.java]
