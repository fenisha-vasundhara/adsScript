...
public class TouchImageView extends ImageView implements View.OnTouchListener{
    ...
    /* renamed from: com.photovideozone.pipcamera.view.TouchImageView$1 */
    ...
    private class Fling implements Runnable {
        ...
        Fling(int velocityX, int velocityY) {
            ...
            TouchImageView.this.matrix.getValues(TouchImageView.this.f1757m);
            int startX = (int) TouchImageView.this.f1757m[2];
            int startY = (int) TouchImageView.this.f1757m[5];
    ...
    private class GestureListener extends SimpleOnGestureListener {
        ...
        /* synthetic */ GestureListener(TouchImageView x0, C14411 x1) {
            this();
        }
    ...
    private class PrivateOnTouchListener implements OnTouchListener {
        ...
        /* synthetic */ PrivateOnTouchListener(TouchImageView x0, C14411 x1) {
            this();
        }
    ...
    private class ScaleListener extends SimpleOnScaleGestureListener {
        ...
        /* synthetic */ ScaleListener(TouchImageView x0, C14411 x1) {
            this();
        }
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            Log.d("123456", "onScale: "+detector.getScaleFactor());
            if (TouchImageView.this.touchImageViewListener != null) {
                TouchImageView.this.touchImageViewListener.onMove();
            }
            return true;
    ...
    private void savePreviousImageValues() {
        if (this.matrix != null && this.viewHeight != 0 && this.viewWidth != 0) {
            this.matrix.getValues(this.f1757m);
            this.prevMatrix.setValues(this.f1757m);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        this.matrix.getValues(this.f1757m);
        bundle.putFloatArray("matrix", this.f1757m);
        bundle.putBoolean("imageRendered", this.imageRenderedAtLeastOnce);
        return bundle;
    }

    public void onRestoreInstanceState(Parcelable state2) {
      try{  if (state2 instanceof Bundle) {
            Bundle bundle = (Bundle) state2;
            this.normalizedScale = bundle.getFloat("saveScale");
            this.f1757m = bundle.getFloatArray("matrix");
            this.prevMatrix.setValues(this.f1757m);
    ...
    public void onDraw(Canvas canvas) {
        Log.d("123456", "onDraw: "+delayedZoomVariables.scale);
    ...
    public void setZoom(float scale, float focusX, float focusY, ScaleType scaleType) {
        ...
        this.matrix.getValues(this.f1757m);
        this.f1757m[2] = -((getImageWidth() * focusX) - (((float) this.viewWidth) * 0.5f));
        this.f1757m[5] = -((getImageHeight() * focusY) - (((float) this.viewHeight) * 0.5f));
        this.matrix.setValues(this.f1757m);
        fixTrans();
        setImageMatrix(this.matrix);
    }
    ...
    public void fixTrans() {
        this.matrix.getValues(this.f1757m);
        float transX = this.f1757m[2];
        float transY = this.f1757m[5];
    ...
    public void fixScaleTrans() {
        ...
        if (getImageWidth() < ((float) this.viewWidth)) {
            this.f1757m[2] = (((float) this.viewWidth) - getImageWidth()) / 2.0f;
        }
        if (getImageHeight() < ((float) this.viewHeight)) {
            this.f1757m[5] = (((float) this.viewHeight) - getImageHeight()) / 2.0f;
        }
        this.matrix.setValues(this.f1757m);
    }
    ...
    private void fitImageToView() {
        ...
        if (drawable != null && drawable.getIntrinsicWidth() != 0 && drawable.getIntrinsicHeight() != 0 && this.matrix != null && this.prevMatrix != null) {
            ...
            switch (C14411.$SwitchMap$android$widget$ImageView$ScaleType[this.mScaleType.ordinal()]) {
                case 1:
                    scaleY = 1.0f;
                    scaleX = 1.0f;
                    break;
            ...
            Log.d("123456", "fitImageToView: before"+scaleX+"  "+scaleY);
            ...
            Log.d("123456", "fitImageToView: after"+scaleX+"  "+scaleY);
            ...
            Log.d("123456", "fitImageToView: "+redundantXSpace+"  "+redundantYSpace);
            ...
            if (isZoomed() || this.imageRenderedAtLeastOnce) {
                ...
                this.prevMatrix.getValues(this.f1757m);
                this.f1757m[0] = (this.matchViewWidth / ((float) drawableWidth)) * this.normalizedScale;
                this.f1757m[4] = (this.matchViewHeight / ((float) drawableHeight)) * this.normalizedScale;
                float transX = this.f1757m[2];
                float transY = this.f1757m[5];
    ...
    private void translateMatrixAfterRotate(int axis, float trans, float prevImageSize, float imageSize, int prevViewSize, int viewSize, int drawableSize) {
        if (imageSize < ((float) viewSize)) {
            this.f1757m[axis] = (((float) viewSize) - (((float) drawableSize) * this.f1757m[0])) * 0.5f;
        } else if (trans > 0.0f) {
            this.f1757m[axis] = -((imageSize - ((float) viewSize)) * 0.5f);
        } else {
            this.f1757m[axis] = -((((Math.abs(trans) + (((float) prevViewSize) * 0.5f)) / prevImageSize) * imageSize) - (((float) viewSize) * 0.5f));
        }
    }
    ...
    public void scaleImage(double deltaScale, float focusX, float focusY, boolean stretchImageToSuper) {
        Log.d("123456", "scaleImage: "+deltaScale);
        float lowerScale;
        float upperScale;
    ...
    public PointF transformCoordTouchToBitmap(float x, float y, boolean clipToBitmap) {
        ...
        float finalY = ((y - this.f1757m[5]) * origH) / getImageHeight();
        if (clipToBitmap) {
    ...
    public PointF transformCoordBitmapToTouch(float bx, float by) {
        this.matrix.getValues(this.f1757m);
        return new PointF(this.f1757m[2] + (getImageWidth() * (bx / ((float) getDrawable().getIntrinsicWidth()))), this.f1757m[5] + (getImageHeight() * (by / ((float) getDrawable().getIntrinsicHeight()))));
    }
