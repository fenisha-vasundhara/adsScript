...
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.GeocoderDataSourceInterface
...
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.GeocoderViewInterface
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.GoogleGeocoderDataSource
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.PlaceSuggestion
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.adapters.DefaultAddressAdapter
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.adapters.DefaultSuggestionAdapter
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.adapters.SearchViewHolder
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.adapters.SuggestionViewHolder
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.adapters.base.LekuSearchAdapter
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.api.AddressBuilder
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.api.NetworkClient
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.api.SuggestionBuilder
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.places.GooglePlacesDataSource
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.geocoder.timezone.GoogleTimeZoneDataSource
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.locale.DefaultCountryLocaleRect
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.locale.SearchZoneRect
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.permissions.PermissionUtils
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.tracker.TrackEvents
import com.messenger.phone.number.text.sms.service.apps.mapBuilder.utils.ReactiveLocationProvider
...
class LocationPickerActivity :
    ...
    private var searchEditLayout: ConstraintLayout? = null
    ...
    fun ComponentActivity.setBaseThemeLight111() {
...
//        }
    ...
    private fun setUpMainVariables() {
        ...
        clearLocationButton.apply {
            // Make sure srcCompat is set in XML or here if needed
            // ImageViewCompat.setImageResource(this, R.drawable.leku_ic_close)  // optional
    ...
    private fun setUpToolBar() {
        ...
        toolbar.apply {
            ...
            setNavigationIconTint(getProperPrimaryColor())
        }
    ...
    private fun setUpSearchView() {
        ...
        searchView!!.setTextColor(getColor(R.color.black2))


//        searchView!!.setCursorColorProgrammaticallyet(getProperPrimaryColor())
    ...
    private fun setUpFloatingButtons() {
        ...
        btnAcceptLocation.backgroundTintList =ColorStateList.valueOf(getProperPrimaryColor())
    ...
    class Builder(val context: Context) {
        ...
        fun build(): Intent {
            ...
            Companion.customDataSource = customDataSource
            Companion.customAdapter = customAdapter
            Companion.currentLocationBitmapMaker = currentLocationBitmapMaker
            Companion.otherLocationBitmapMaker = otherLocationBitmapMaker
            return intent
        }
    }
