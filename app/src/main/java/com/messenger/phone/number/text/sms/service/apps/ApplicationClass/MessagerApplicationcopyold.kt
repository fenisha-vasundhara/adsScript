...
//import com.demo.adsmanage.Activity.Paywall_dynamic_Activity
...
//import com.messenger.phone.number.text.sms.service.apps.ads.listAppOpen
...
//import com.vision.aftercall.sdk.ads.ApplovinApp
//import com.vision.aftercall.sdk.ads.CallerBannerAds
...
//import com.vision.aftercall.sdk.core.AfterCallScreenEventListener
...
//import com.vision.aftercall.sdk.core.CallMonitoringMode
//import com.vision.aftercall.sdk.core.CallerModule
//import com.vision.aftercall.sdk.core.CallerModule.setOnesignalIAP
//import com.vision.aftercall.sdk.core.DefaultAfterCallUiConfig
//import com.vision.aftercall.sdk.core.events.TikTokEventSetup
...
// . 13-5-2026 for aftercall backup whole project code



//@HiltAndroidApp
//class MessagerApplicationcopyold : AppSubscription(), SubPerchechComplete, SubPerchechMainComplete,
...
//    private val afterCallModuleInitialized = AtomicBoolean(false)
...
//
//
//        var singleton: MessagerApplicationcopyold? = null
//        var coldStart = true
//        private const val TAG = "BalanceCheckerApplication"
//
//        @JvmStatic
//        val instance: MessagerApplicationcopyold?
//            get() {
//                if (singleton == null) {
//                    singleton = MessagerApplicationcopyold()
//                }
//                return singleton
//            }
//
...
//            val themeMode = ThemeModeManager.getThemeMode(this@MessagerApplicationcopyold)
...
//
//        appStartupScope.launch(Dispatchers.IO) {
//            FirebaseApp.initializeApp(this@MessagerApplicationcopyold)
...
//                this@MessagerApplicationcopyold,
//                android.R.drawable.ic_menu_close_clear_cancel
//            )
//        }
//
//        appStartupScope.launch(Dispatchers.IO) {
//            AdsManage.ActivityBuilder().ApplicationCall(this@MessagerApplicationcopyold)
...
//                .setAppName(
//                    this@MessagerApplicationcopyold.resources.getString(R.string.app_name),
...
//                .setAppIcon(this@MessagerApplicationcopyold.resources.getDrawable(R.drawable.appicon_sub))
//                .setPremium_True_Icon(this@MessagerApplicationcopyold.resources.getDrawable(R.drawable.check))
//                .setBasic_Line_Icon(this@MessagerApplicationcopyold.resources.getDrawable(R.drawable.line))
//                .setBaseSubscriptionBackground(this@MessagerApplicationcopyold.resources.getDrawable(R.drawable.bg))
//                .setSubscriptionBackground(this@MessagerApplicationcopyold.resources.getDrawable(R.drawable.bg))
//                .setClose_Icon(closeIcon)
//                .setPremium_CardSelected_Icon(this@MessagerApplicationcopyold.resources.getDrawable(R.drawable.ic_pro_selected))
//                .setPremium_Cardunselected_Icon(this@MessagerApplicationcopyold.resources.getDrawable(R.drawable.ic_pro_selection))
//                .setPremium_Button_Icon(this@MessagerApplicationcopyold.resources.getDrawable(R.drawable.bg_sub_btn_))
//                .Subcall(this@MessagerApplicationcopyold).CallSubLister(this@MessagerApplicationcopyold)
//                .CallSubListerNew(this@MessagerApplicationcopyold)
//
//            firebaseAnalytics = FirebaseAnalytics.getInstance(this@MessagerApplicationcopyold)
//            FacebookSdk.setAutoLogAppEventsEnabled(false)
//            AppEventsLogger.activateApp(this@MessagerApplicationcopyold)
//            TikTokEventSetup.getInstance().isTiktokOn = false
...
//            Experiment_Sub_Screen_Activity::class.java,
//            Paywall_FourPlan_Activity::class.java,
//            Paywall_dynamic_Activity::class.java
//
//        )
//
//    }
...
//        if (BaseSharedPreferences(this@MessagerApplicationcopyold).mIS_SUBSCRIBED) {
//            setOnesignalIAP("true")
//        } else {
//            setOnesignalIAP("false")
//        }
//    }
//
...
//
//
//            if (!gooutside && !isTakingPermission || config.All_Ads_On || !BaseSharedPreferences(
//                    this
//                ).mIS_SUBSCRIBED!!
//            ) {
//                CoroutineScope(Dispatchers.IO).launch {
//                    loadAndShowAppOpenAd(it, resumeAppPlace, ArrayList(listAppOpen))
//                }
//            }
//        }
...
//            (activity as DefaultAfterCallActivity).intent
//            return
//        }
...
//        val first = firstActivityClassName ?: return false
//        return first !in setOf(
//            "com.vision.aftercall.sdk.ui.DefaultAfterCallActivity",
//            "com.vision.aftercall.sdk.ui.ResumeMonitoringActivity"
//        )
//    }
//
...
//                Clarity.initialize(this@MessagerApplicationcopyold, configmic)
//            } catch (t: Throwable) {
...
//
//        Handler(Looper.getMainLooper()).post {
//            initializeAfterCallModuleIfNeeded()
//
//
//
//        }
//    }
//
//    private fun initializeAfterCallModuleIfNeeded() {
//        if (!afterCallModuleInitialized.compareAndSet(false, true)) {
//            return
//        }
//
//        try {
//            ApplovinApp.getInstance().initAppLovin(
//                this@MessagerApplicationcopyold,
//                "eruI7aE39Fwu0q7Jmet5Sk1p7p3rJSR-oFggKdAWDdsTAux2__wIXaFIh8Re3c1IgWRs1QZa8n1KQdupymguA5",
//                false
//            )
//            if (CallerModule.isInitialized()) {
//                Log.d(TAG, "onCreate: CallerModule already fully initialized; skipping heavy init")
//                return
//            }
//
//
//            // ---------- 1. RevenueCat ----------
//            Purchases.logLevel = com.revenuecat.purchases.LogLevel.DEBUG // remove in production
//            Purchases.configure(
...
//                initOneSignalKey(
//                    app = this@MessagerApplicationcopyold,
//                    appId = "beaaedec-07fd-4ff1-b108-3d5afacf9dcf",
//                    blockActivities = arrayListOf<Activity>(),
//                    Id = { id ->
//                        onesignalUserSaveId = id.toString()
////                        onesignalUserSaveId = OneSignal.User.onesignalId.toString()
//
//                    },
//                    oneSignalCallBacks = object : OneSignalCallBacks {
...
//                    callerIdScreen = true,
//                    floatingLayoutRes = null,
//                    adLayout = null
//                )
//                Log.d("TAG", "onCreate:response:----- ${config.aftercall_Priority}")
//                when (config.aftercall_Priority) {
//                    1 -> {
//                        configureNativeAds(
//                            afterCallAdUnits = listOf(MS_Native_Aftercall_Low),
//                            floatingAdUnits = emptyList()
//                        )
//                        setAfterCallAdWaterfall(listOf(1))
//                    }
//
//                    2 -> {
//                        configureBannerAds(
//                            afterCallAdUnits = arrayListOf(MS_Banner_Aftercall_Low),
//                            floatingAdUnits = emptyList(),
//                            bannerType = CallerBannerAds.BannerType.ADAPTIVE
//                        )
//                        setAfterCallAdWaterfall(listOf(2))
//                    }
//
//                    3 -> {
//                        configureMrBannerAds(
//                            afterCallAdUnits = listOf(MS_Banner_AFTERCALL_MREC),
//                            floatingAdUnits = emptyList(),
//                        )
//                        setAfterCallAdWaterfall(listOf(3))
//                    }
//
//                    0 -> {
//                        val sequence = config.aftercall_Sequence
//                        val list = sequence.toString().map { it.toString().toInt() }
//                        Log.d("TAG", "onCreate:response:-----list____ $list")
//                        configureAds(
//                            nativeAfterCallAdUnits = listOf(MS_Native_Aftercall_Low),
//                            nativeFloatingAdUnits = listOf(),
//                            adaptiveAfterCallBannerAdUnits = listOf(MS_Banner_Aftercall_Low),
//                            adaptiveFloatingBannerAdUnits = listOf(),
//                            afterCallWaterfall = list,
//                            mrAfterCallBannerAdUnits = listOf(MS_Banner_AFTERCALL_MREC),
//                            mrFloatingBannerAdUnits = listOf(),
//                        )
//                    }
//                }
//                setAfterCallMAX(false)
//                setPreloadSwitch(true)
//                setAfterCallNavHide(false)
//                setCallObservingFlowEnabled(
//                    CallMonitoringMode.OBSERVING, this@MessagerApplicationcopyold
//                )
//                registerAfterCallBackPressListener(
//                    HomeABActivity::class.java, "Aftercallscreen"
//                )
//                setCallerMissedCallAvoids(config.Misscall_Aftercall_OFF)
//                setSubscriptionStatus()
//                setCallerScreenOpenTime(config.afterCall_Delay)
//                setEndPreloadSwitch(true)
//                setCallerScreenWithNet(true)
//                setAutoReloadAds(false)
//                addAfterCallScreenEventListener(listener = object :
//                    AfterCallScreenEventListener {
//                    override fun onAfterCallScreenEvent(eventName: String) {
//                        firebaseFunnel(eventName)
//                    }
//
//                    override fun onAfterCallCounter(
//                        eventName: String, bundle: Bundle
//                    ) {
//                        val firebaseAnalytics: FirebaseAnalytics =
//                            FirebaseAnalytics.getInstance(this@MessagerApplicationcopyold)
//                        firebaseAnalytics.logEvent(eventName, bundle)
//
//                        val payload = bundle.keySet().joinToString(", ") { key ->
//                            "$key=${bundle.get(key)}"
//                        }
//                        Log.d("TAGFFF", "onCreate: : $eventName\nbundle:$payload")
//                    }
//                })
//
...
//                val defaultAfterCallUiConfig =
//                    DefaultAfterCallUiConfig.builder().setPackageName(packageName)
//                        .setThemeColor(R.color.appcolor)
...
//                        .setShareText("Try our caller ID app!").setQuickMessagesRes(
//                            listOf(
//                                R.string.sorry_i_can_t_talk_right_now,
//                                R.string.can_i_call_you_later,
//                                R.string.i_m_on_my_way
//                            )
//                        ).setShowAds(true).setFragmentClass(
//                            MessageListFragment::class.java, bundleOf("extra" to "value")
//                        ).build()
...
//                }
//                Log.d(TAG, "onCreate: --> CallerModule configureDefaultAfterCallUi ")
//                configureDefaultAfterCallUi(defaultAfterCallUiConfig)
//            }
//        } catch (se: SecurityException) {
//            afterCallModuleInitialized.set(false)
//            Log.d(TAG, "onCreate: --> CallerModule SecurityException ${se.message}")
//        } catch (t: Throwable) {
//            afterCallModuleInitialized.set(false)
//            Log.d(TAG, "onCreate: --> CallerModule Throwable ${t.message}")
//        }
//    }
//
...
//                          Log.d("DeviceID", "Advertising ID: ${adInfo.id}")
//                      } catch (e: Exception) {
//                          Log.e("DeviceID", "Failed to get Advertising ID", e)
//                      }
//                  }
//
//                  // === Main Thread Code ===
//
//                  val testDeviceIds = listOf("8CA2EC40C8D7DCD30992848FD548BAA3");
//
...
//
//                    if (error != null) {
//                        Log.e("AdsInspector", error.message.toString())
//                    } else {
//                        Log.d("AdsInspector", "Closed")
//                    }
//                }
//
//            } catch (t: Throwable) {
...
//        VesionCheck()
//        CoroutineScope(Dispatchers.IO).launch {
//            GlobalTimer.init(this@MessagerApplicationcopyold)
