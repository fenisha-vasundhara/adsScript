...
abstract class SendStatusReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val SMS_SENT_ACTION = "com.messenger.phone.number.text.sms.service.apps.receiver.SMS_SENT"
        const val SMS_DELIVERED_ACTION = "com.messenger.phone.number.text.sms.service.apps.receiver.SMS_DELIVERED"
