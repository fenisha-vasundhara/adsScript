...
@HiltViewModel
class GetAllScheduleConversationViewModel @Inject constructor(messagerDatabaseRepo: MessagerDatabaseRepo) : ViewModel() {
    ...
    init {
        GetAllConversationlist.addSource(messagerDatabaseRepo.getallScheduleconversationurepo(), Observer {
