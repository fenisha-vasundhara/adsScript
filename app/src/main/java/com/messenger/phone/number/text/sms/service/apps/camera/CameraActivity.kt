...
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.GestureDetectorListener
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.MediaSoundHelper
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.PhotoProcessor
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.TabSelectedListener
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.setShadowIcon
import com.messenger.phone.number.text.sms.service.apps.camera.helpers.toFlashModeId
import com.messenger.phone.number.text.sms.service.apps.camera.implementations.CameraXInitializer
import com.messenger.phone.number.text.sms.service.apps.camera.implementations.CameraXPreviewListener
import com.messenger.phone.number.text.sms.service.apps.camera.implementations.MyPreview
import com.messenger.phone.number.text.sms.service.apps.camera.models.ResolutionOption
...
import com.messenger.phone.number.text.sms.service.apps.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity(), PhotoProcessor.MediaSavedListener,
        ...
        override fun onTabSelected(tab: TabLayout.Tab) {
            handlePermission(PERMISSION_RECORD_AUDIO) {
                if (it) {
                    ...
                    toastMess(com.simplemobiletools.commons.R.string.no_audio_permissions)
                    selectPhotoTab()
...
//            mFocusCircleView.setStrokeColor(getProperPrimaryColor())
    ...
    private fun tryInitCamera() {
        handlePermission(PERMISSION_CAMERA) { grantedCameraPermission ->
            if (grantedCameraPermission) {
                ...
                toastMess(com.simplemobiletools.commons.R.string.no_camera_permissions)
                finish()
            }
        }
    }
    ...
    private fun initializeCamera(isInPhotoMode: Boolean) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(binding.viewHolder) { _, windowInsets ->
            ...
            val marginBottom =
                safeInsetBottom + navigationBarHeight + resources.getDimensionPixelSize(com.simplemobiletools.commons.R.dimen.bigger_margin)
    ...
    private fun setButtonColors(button: MaterialButton) {
        ...
        val iconColors = intArrayOf(
            ContextCompat.getColor(
                this,
                com.simplemobiletools.commons.R.color.md_grey_white
            ), primaryColor
        )
