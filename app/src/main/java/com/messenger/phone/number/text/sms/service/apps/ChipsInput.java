...
import com.messenger.phone.number.text.sms.service.apps.CustomEditText.adapter.ChipsAdapter;
import com.messenger.phone.number.text.sms.service.apps.CustomEditText.model.Chip;
import com.messenger.phone.number.text.sms.service.apps.CustomEditText.model.ChipInterface;
import com.messenger.phone.number.text.sms.service.apps.CustomEditText.util.ActivityUtil;
import com.messenger.phone.number.text.sms.service.apps.CustomEditText.util.MyWindowCallback;
...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    public void removeChipByPos(int index) {
        mChipsAdapter.removeChip(index);
    }
