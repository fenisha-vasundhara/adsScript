...
import com.messenger.phone.number.text.sms.service.apps.databinding.MenuSearchAbBcpBinding
import com.simplemobiletools.commons.extensions.removeBit


class MySearchMenuABBCP(context: Context, attrs: AttributeSet) : AppBarLayout(context, attrs) {


    val binding = MenuSearchAbBcpBinding.inflate(LayoutInflater.from(context), this, true)
