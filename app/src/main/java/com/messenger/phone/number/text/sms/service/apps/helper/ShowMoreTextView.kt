...
import com.messenger.phone.number.text.sms.service.apps.helper.ShowMoreTextView
import io.reactivex.annotations.Nullable


class ShowMoreTextView : androidx.appcompat.widget.AppCompatTextView {
        ...
        vto.addOnGlobalLayoutListener(object : ViewTreeObserver.OnGlobalLayoutListener {
            override fun onGlobalLayout() {
                ...
                if (isCharEnable) {
                    ...
                    var newText = showingText.substring(0, showingText.length - (dotdot.length + showMore.length + MAGIC_NUMBER))
                    Log.d(TAG, "Text: $newText")
    ...
    companion object {
        private val TAG: String = ShowMoreTextView::class.java.name
    }
}