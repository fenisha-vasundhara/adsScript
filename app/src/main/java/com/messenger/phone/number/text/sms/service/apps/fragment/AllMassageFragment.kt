...
import com.messenger.phone.number.text.sms.service.apps.databinding.FragmentAllMassageBinding
...
@AndroidEntryPoint
class AllMassageFragment : Fragment(), MessageClick, MoreOPtionClick {

    private lateinit var star: StarNumber
    lateinit var binding: FragmentAllMassageBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_all_massage, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            adapterMainMassage.setInterface(this@AllMassageFragment)
            adapterMainMassage.setInterfaceMoreClick(this@AllMassageFragment)

            model = ViewModelProvider(requireActivity())[GetAllConversationViewModel::class.java]
