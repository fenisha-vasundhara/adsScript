...
class FilepickerFavoritesAdapter(
    activity: Activity, val paths: List<String>, recyclerView: MyRecyclerView,
    itemClick: (Any) -> Unit
    ...
    private fun setupView(view: View, path: String) {
        ...
        val filepicker_favorite_label = view.findViewById<MyTextView>(R.id.filepicker_favorite_label)
