...
public class ChipView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        rootView = LayoutInflater.from((AppCompatActivity) getContext()).inflate(R.layout.chip_view, this);
...
//            if (mAvatarIconUri == null) {
//                new SimpleContactsHelper(mDeleteButton.getContext()).loadContactImage("", mAvatarIconImageView, mLabel, null);
//            } else {
//                new SimpleContactsHelper(mDeleteButton.getContext()).loadContactImage(mAvatarIconUri.toString(), mAvatarIconImageView, mLabel, null);
//            }
