...
@HiltViewModel
class GetAllConversationArchivedViewModel @Inject constructor(messagerDatabaseRepo: MessagerDatabaseRepo) : ViewModel() {
    ...
    init {
        GetAllConversationlist.addSource(messagerDatabaseRepo.getallconversationunarchivOrnotrepo(), Observer {
