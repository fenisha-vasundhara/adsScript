package com.messenger.phone.number.text.sms.service.apps.recyclerviewCustom
...
open class MyRecyclerView : RecyclerView {
    ...
    init {
        hotspotHeight = context.resources.getDimensionPixelSize(com.intuit.sdp.R.dimen._5sdp)
