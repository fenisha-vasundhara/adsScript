...
class AutoCompleteTextViewAdapter(val activity: Activity, val contacts: ArrayList<SimpleContact>) : ArrayAdapter<SimpleContact>(activity, 0, contacts) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        listItem!!.apply {
            ...
            val backgroundColor = activity.resources.getColor(R.color.white, activity.theme)
            findViewById<RelativeLayout>(R.id.item_contact_holder).setBackgroundColor(backgroundColor.darkenColor())

            findViewById <com.google.android.material.textview.MaterialTextView>(R.id.item_contact_name).setTextColor(backgroundColor.getContrastColor())
            findViewById <com.google.android.material.textview.MaterialTextView>(R.id.item_contact_number).setTextColor(backgroundColor.getContrastColor())

            if (contact != null) {
                findViewById <com.google.android.material.textview.MaterialTextView>(R.id.item_contact_name).text = contact.name
                findViewById <com.google.android.material.textview.MaterialTextView>(R.id.item_contact_number).text = contact.phoneNumbers.first().normalizedNumber
