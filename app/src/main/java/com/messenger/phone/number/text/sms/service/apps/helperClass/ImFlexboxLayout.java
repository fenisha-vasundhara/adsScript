...
//    }
    ...
    public ImFlexboxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        setWillNotDraw(true); // Optimize drawing
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, R.styleable.ImFlexboxLayout, 0, 0);
        }
    }
...
//    }
    ...
    protected void onFinishInflate() {
        ...
        viewPartMain = findViewById(a.getResourceId(R.styleable.ImFlexboxLayout_viewPartMain, -1));
        viewPartSlave = findViewById(a.getResourceId(R.styleable.ImFlexboxLayout_viewPartSlave, -1));
