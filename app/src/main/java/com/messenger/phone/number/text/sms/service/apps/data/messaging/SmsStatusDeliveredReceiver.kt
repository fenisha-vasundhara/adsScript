...
class SmsStatusDeliveredReceiver : SendStatusReceiver() {
    ...
    override fun updateAndroidDatabase(context: Context, intent: Intent, receiverResultCode: Int) {
        Log.d("", "onReceive: new 22-11 <-----------> 7")
        Log.d("", "updateAndroidDatabase: onReceive: SmsDelBroadcastReceiver <--------->  ")
        ...
        try {
            ...
            if ("3gpp2" == format) {
                ...
                Log.d("", "updateAndroidDatabase: onReceive: SmsDelBroadcastReceiver errorClass 1 <---------> ${errorClass} ")
    ...
    override fun updateAppDatabase(context: Context, intent: Intent, receiverResultCode: Int) {
        ...
        if (messageUri != null) {
            ...
            ensureBackgroundThread {
                if (status != Sms.Sent.STATUS_NONE) {
                    Log.d("jigar", "updateAppDatabase: jigar <----------> ${status}")
                }
